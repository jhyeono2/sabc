<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            Host # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            Host
        </v-card-title >        
        ...
        <v-card-text style="background-color: white;">
            ...
            <String label="GoodsName" v-model="value.goodsName" :editMode="editMode" :inputUI="''"/>
            ...
            <String label="BranchNo" v-model="value.branchNo" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/hosts'), this.value)
                        } else {
