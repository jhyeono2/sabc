<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text style="background-color: white;">
            ...
            <BigDecimal offline label="Price" v-model="value.price" :editMode="editMode" @change="change"/>
            <Number label="Qty" v-model="value.qty" :editMode="editMode" :inputUI="''"/>
            <Date label="TradeDate" v-model="value.tradeDate" :editMode="editMode" :inputUI="''"/>
